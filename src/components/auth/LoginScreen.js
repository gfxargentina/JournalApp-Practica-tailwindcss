     ...
     <> 
            <div>
                ...
                <div className="bg-indigo-600 hidden lg:block w-full md:w-1/2 xl:w-2/3 h-screen ">
                    <img src="https://source.unsplash.com/random" alt="imagen random" className="w-full h-full object-cover animate__animated animate__fadeIn animate__faster"/>
                </div>
                ...
                <div className="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
                    ...
                    <form className="mt-6 animate__animated animate__fadeIn animate__faster"
                        ...
                        <a href="link.html" className="text-sm font-semibold text-gray-700 hover:text-blue-700 focus:text-blue-700">Se olvido su contraseña?</a>
                        </div>
                    ...
                    <button onClick={ handleGoogleLogin } type="button" className="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300">
                            ...
                            <span className="ml-4">
                            Ingrese con su cuenta de Google</span>
                            </div>
                        </button>
                        <Link to="/auth/register">
                        <p className="mt-8">No tiene una cuenta? <a href="link.html" className="text-blue-500 hover:text-blue-700 font-semibold">Registrese aqui</a></p>
                        </Link>
